...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/02 23:01:49 by aartiges          #+#    #+#             */
/*   Updated: 2022/03/02 23:01:50 by aartiges         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_syntax_error_bonus(int state)
{
	...
	else if (state == CHECK_OR)
		ft_putstr_fd("Syntax error: near '||'\n", 2);
	else if (state == CHECK_SUB_OPEN)
		ft_putstr_fd("Syntax error: near '('\n", 2);
	else if (state == CHECK_SUB_CLOSE)
		ft_putstr_fd("Syntax error: near ')'\n", 2);
}
